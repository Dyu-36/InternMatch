...
export default function SolutionsSection() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      description:
        'Hệ thống Dashboard trực quan giúp sinh viên theo dõi trạng thái đơn và giúp nhà tuyển dụng xét duyệt ứng viên tức thì.',
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {solutions.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white rounded-2xl p-8 border border-gray-100 shadow-xs hover:shadow-md transition duration-200 flex flex-col items-start"
              >
