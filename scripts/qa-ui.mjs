...
try {
  ...
  for (const [label, value] of [['Họ và tên', 'QA Student'], ['Trường Đại học', 'QA University'], ['Chuyên ngành', 'Computer Science'], ['Điểm GPA', '3.5'], ['Kỹ năng chuyên môn', 'React, TypeScript'], ['Mục tiêu & Giới thiệu', 'Looking for a frontend internship.']]) await fill(student, label, value);
  ...
  await company.getByLabel('Trạng thái hồ sơ của QA Student').selectOption('ACCEPTED');
